...
const updateCart = async () => {
  if (user) {
    await useClientFetch('add-many-to-cart', {
...
<template>
      ...
      <div class="col-span-3 space-y-4">
        ...
        <div class="w-full overflow-x-auto">
          <div class="min-w-[600px] space-y-4">
            ...
            <div class="bg-white p-4 rounded-lg">
              <!-- Promotion -->
              <div class="bg-orange-100 p-2 rounded-lg text-orange-600 text-sm">Mua 3, giảm 5%</div>
      ...
      <div class="col-span-1 space-y-4">
        <div class="bg-white p-4 rounded-lg">
          ...
          <div class="bg-gray-100 p-4 rounded-lg mb-4">
            ...
            <div class="flex justify-between items-center text-red-500 font-semibold mb-4">
              <span>Tổng tiền</span>
  ...
  <Toast :message="message" :type="status" :show="showToast" @update:show="showToast = $event" />
</template>
