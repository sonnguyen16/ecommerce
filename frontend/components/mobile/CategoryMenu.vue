<template>
  <div id="category-menu" :class="[show ? 'left-0' : '-left-full' ]" class="border-r bg-white px-2 py-3 fixed top-0 bottom-[50px] z-[9999] md:hidden transition-all duration-500">
