    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-2">
      <div>
        ...
        <ul class="space-y-1">
          ...
          <li><a href="#" class="font-normal text-gray-500 hover:underline">Gửi yêu cầu hỗ trợ</a></li>
          <li><a href="#" class="font-normal text-gray-500 hover:underline">Hướng dẫn đặt hàng</a></li>
          <li><a href="#" class="font-normal text-gray-500 hover:underline">Phương thức vận chuyển</a></li>
      ...
      <div>
        ...
        <div class="mt-4">
          ...
          <div class="flex gap-2 items-center mt-2">
            <img src="/certificate.png" width="32" alt="DMCA Protected">
            <img src="/certificate1.png" width="85" alt="DMCA Protected">
            <img src="/certificate2.png" width="32" alt="DMCA Protected">
          </div>
        </div>
      </div>
      <div>
      ...
      <div class="">
        ...
        <h2 class="font-semibold mt-2">Tải ứng dụng trên điện thoại</h2>
        <div class="flex space-x-4 mt-2">
          <img src="/qrcode.png" alt="QR Code" class="w-20 h-20">
          <div>
            <img src="/appstore.png" class="h-10 mb-1" alt="App Store">
            <img src="/playstore.png" class="h-10" alt="Google Play">
          </div>
        </div>
      </div>
    </div>
