...
<template>
  <NuxtLink :to="`/products/${product.slug}`">
    <div class="rounded-xl border border-gray-200 hover:shadow-lg min-w-[120px]">
      <img :src="mediaUrl + product.thumbnail" alt="product" class="w-full rounded-tl-xl rounded-tr-xl max-h-[186px] object-cover">
      ...
      <div class="px-3 py-2">
        ...
        <div class="flex gap-2 items-center">
          ...
          <span class="text-gray-600 line-through font-normal lg:text-[14px] text-sm">{{ formatCash(product.price?.toString())  }} đ</span>
        </div>
