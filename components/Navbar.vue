...
<template>
  <nav class="py-[10px] border-b lg:block hidden">
    <div class="container flex justify-between items-center">
      <NuxtLink to="/">
        <img src="/logo.png" alt="logo" class="w-[96px]" />
        <p class="text-blue-800 text-center">Tốt & nhanh</p>
      </NuxtLink>
      ...
      <div>
        <ul class="flex gap-6 items-center">
          <li>
            <NuxtLink to="/" class="flex justify-center items-center space-x-1">
              <HomeIcon class="w-6 h-6 text-blue-700" />
              <span class="text-blue-700">Trang chủ</span>
            </NuxtLink>
          </li>
          <li>
            <NuxtLink
            ...
            >
              <FaceSmileIcon class="w-6 h-6 text-gray-500" />
          ...
          <li>
            <NuxtLink
              ...
              class="flex justify-center items-center space-x-1"
            >
              <ShoppingCartIcon class="w-6 h-6 text-gray-500" />
